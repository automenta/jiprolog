...
interface JIPTraceListener
{
  /** Notifies a Call event
    ...
    * @see com.ugos.jiprolog.engine.JIPTraceEvent
    */
  void callNotified(JIPTraceEvent e);
    
  /** Notifies a Found event
    * @param e event occurred
    * @see com.ugos.jiprolog.engine.JIPTraceEvent
    */
  void foundNotified(JIPTraceEvent e);
    
  /** Notifies a Bind event
    * @param e event occurred
    * @see com.ugos.jiprolog.engine.JIPTraceEvent
    */
  void bindNotified(JIPTraceEvent e);

    /** Notifies a Fail event
      * @param e event occurred
      * @see com.ugos.jiprolog.engine.JIPTraceEvent
      */
    void failNotified(JIPTraceEvent e);

  /** Notifies a Redo event
    * @param e event occurred
    * @see com.ugos.jiprolog.engine.JIPTraceEvent
    */
  void redoNotified(JIPTraceEvent e);
    
    /** Notifies an Exit event
    * @param e event occurred
    * @see com.ugos.jiprolog.engine.JIPTraceEvent
    */
    void exitNotified(JIPTraceEvent e);
    
    /** Notifies a Start event
    * @param e event occurred
    * @see com.ugos.jiprolog.engine.JIPTraceEvent
    */
    void startNotified(JIPTraceEvent e);
    
    /** Notifies a Stop event
    * @param e event occurred
    * @see com.ugos.jiprolog.engine.JIPTraceEvent
    */
    void stopNotified(JIPTraceEvent e);
