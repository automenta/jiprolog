...
import com.ugos.jiprolog.util.ClassLoaderEx;
import com.ugos.jiprolog.util.JARClassProvider;
...
//                    ex.printStackTrace();  // DBG
     ...
     * @see com.ugos.jiprolog.engine.JIPEngine#setSearchPath
     */
    public final void packFiles(final String[] strFileNames, final String strDestinationFile) throws JIPSyntaxErrorException, IOException
    {
...
//            throw JIPRuntimeException.create(28, strStreamName);
     ...
     */
    public JIPQuery querySynch(final String strQuery) throws JIPSyntaxErrorException
    {
        return querySynch(m_termParser.parseTerm(strQuery));
    }
     ...
     */
    public synchronized JIPQuery querySynch(final JIPTerm jipquery)
    {
     ...
     */
    public final JIPTermParser parser()
    {
        return m_termParser;
    }
...
//    }
    ...
    public JIPTerm parse(String term) {
